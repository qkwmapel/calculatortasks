...
let multiplyResult = calculator.calculate(oper: "*", firstNumber: 4, secondNumber: 2)// 곱셈 연산
let divideResult = calculator.calculate(oper: "/", firstNumber: 6, secondNumber: 2)// 나눗셈 연산
